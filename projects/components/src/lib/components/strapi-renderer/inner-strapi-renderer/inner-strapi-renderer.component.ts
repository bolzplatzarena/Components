...
import { DefaultInlineNode, LinkInlineNode, ParagraphBlockNode, RootNode, TextInlineNode } from '../../../models/strapi-content.model';
...
@Component({
  ...
  imports: [TextRendererComponent, LinkRendererComponent],
